...
l[d].pop());break;case "u":if(0<a.length)for(b=M(a.pop()),c=0;c<b;c++){var f=l[d][l[d].length-2].pop();a.push("undefined"===typeof f?0:f)}break;case "x":1<a.length&&(d=a.pop(),a=a.pop(),b.y=d,b.x=a);break;case "[":a=b.x;b.x=-b.y;b.y=a;break;case "]":a=b.x;b.x=b.y;b.y=-a;break;case "w":1<a.length&&(d=a.pop(),a=a.pop(),a<d?(a=b.x,b.x=-b.y,b.y=a):a>d&&(a=b.x,b.x=b.y,b.y=-a));break;case "t":a=[];f=g(l[d]);for(var k=f.next();!k.done;k=f.next())stack=k.value,a.push(stack.slice());h.splice(d,0,{h:{x:c.x,
y:c.y},i:{x:-b.x,y:-b.y}});u.splice(d,0,!1);l.splice(d,0,a);return"newPointer";case "'":c.x=(c.x+b.x)%n;c.y=(c.y+b.y)%p;0>c.x&&(c.x=n+c.x);0>c.y&&(c.y=p+c.y);"undefined"===typeof m[c.y][c.x]?a.push(BigInt(32)):"string"===typeof m[c.y][c.x]?a.push(BigInt(m[c.y][c.x].charCodeAt(0))):a.push(m[c.y][c.x]);break;case "s":c.x=(c.x+b.x)%n;c.y=(c.y+b.y)%p;0>c.x&&(c.x=n+c.x);0>c.y&&(c.y=p+c.y);0<a.length&&(a=a.pop(),31<a&&127>a?L(String.fromCharCode(M(a)),c.x,c.y):L(a,c.x,c.y));break;case "r":b.x*=-z,b.y*=
-z}}
...
"}":ä,u:ä,".":ã,",":ã,"&":ã,"~":ã,'"':ã,"'":ã,s:ã,q:å,"@":å,g:æ,p:æ,t:"magenta"},O=!1,Q={1:'"!dlrow olleH"v,_@\n              >:^',2:'#vt#vt#vt#vt#vt#vr\n v  v  v  v  v  "\n v  v  v  v  v  e\n v  v  v  v  "  H\n v  v  v  v  l  "\n v  v  v  "  l\n v  v  v     "\n v  v  "  o\n v  v  o  "\n v  "  w\n v  l  "\n "  r\n !  "\n d\n "\n>>>>>>>>>>>>>>>>>>>>>,,@',3:"&:>00pv\n  *   1\n  g   -\n  0   :\n.@^0 :_00g",4:'&:." =",,:v ; Factors an integer\nv  _v#`0:<_0.@\n -10<    ^*-10\\\n\n>00p>00g1-#v_>:#._@\n^/\\g00:<   2\n     >   1+v\n     ^_^#%<:\n          \\0\n          g0\n          ^<',
